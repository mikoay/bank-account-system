...
void Customer::open_account()
{
    ...
    switch (choice - 1){
        ...
        case COMPANY:
		    ...
		    std::getline(std::cin, company_nip);
            sleep(1);
            clear();
...
void PolishCustomer::info() const
{
	...
	std::cout << "PESEL: " << this->get_id() << std::endl;
	std::cout << "Address: " << this->get_address() << std::endl;
	std::cout << "Postal code: " << this->get_postal_code() << std::endl;
	std::cout << "City: " << this->get_city() << std::endl;
	std::cout << "Phone number: " << this->get_phone_number() << std::endl;
	std::cout << "E-mail: " << this->get_mail() << std::endl;
}
...
void ForeignCustomer::info() const
{
	...
	std::cout << "Surname: " << this->get_surname() << std::endl;
	std::cout << "Date of birth: " << this->get_date_of_birth() << std::endl;
	std::cout << "Passport: " << this->get_id() << std::endl;
	std::cout << "Address: " << this->get_address() << std::endl;
	std::cout << "Postal code: " << this->get_postal_code() << std::endl;
	std::cout << "City: " << this->get_city() << std::endl;
	std::cout << "Phone number: " << this->get_phone_number() << std::endl;
